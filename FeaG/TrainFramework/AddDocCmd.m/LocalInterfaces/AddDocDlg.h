...
private:
	...
	CATDlgSpinner*      _Spinner024; // Rx(显示 Degree，GetValue 为 rad)
	CATDlgSpinner*      _Spinner026; // Rz(显示 Degree，GetValue 为 rad)
	CATDlgSpinner*      _Spinner027; // Ry(显示 Degree，GetValue 为 rad)
